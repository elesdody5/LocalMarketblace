...
import '../auth/usecase/reset_password_usecase.dart' as _i1053;
...
_i174.GetIt initDomainGetIt(
  ...
  gh.factory<_i375.ResendVerificationCodeUseCase>(
    () => _i375.ResendVerificationCodeUseCase(),
  );
  ...
  gh.factory<_i1053.ResetPasswordUseCase>(
    () => _i1053.ResetPasswordUseCase(gh<_i778.AuthRepository>()),
  );
