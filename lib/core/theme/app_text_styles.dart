...
/// Typography configuration for the Local Marketplace app
/// Supports both Arabic and English text with appropriate fonts
class AppTextStyles {
  AppTextStyles._();
  ...
  // Price text styles (specific to marketplace)
